...
RUN /elasticsearch/bin/plugin install https://github.com/jaohaohsuan/elasticsearch-analysis-ik/releases/download/v1.9.1-beta.0/elasticsearch-analysis-ik-1.9.1.zip --verbose
